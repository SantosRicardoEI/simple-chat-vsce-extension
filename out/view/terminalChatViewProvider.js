...
exports.TerminalChatViewProvider = void 0;
const vscode = __importStar(require("vscode"));
class TerminalChatViewProvider {
    context;
    sessionManager;
    view = null;
    disposables = [];
    ...
    resolveWebviewView(webviewView) {
        ...
        this.disposables.push(messageDisposable, visibilityDisposable, disposeDisposable);
    ...
    registerManagerListeners() {
        ...
        this.sessionManager.on("users_list", (users) => {
            this.postMessage({
                type: "users_list",
                payload: {
                    users,
        ...
        this.sessionManager.on("error", (message) => {
            this.postMessage({
                type: "error",
                payload: {
                    message,
...
exports.TerminalChatViewProvider = TerminalChatViewProvider;
//# sourceMappingURL=terminalChatViewProvider.js.map